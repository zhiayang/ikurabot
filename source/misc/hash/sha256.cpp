// sha256.cpp
// Licensed under the Public Domain, by Alain Mosnier
// Original source from https://github.com/amosnier/sha-2
...
static void init_buf_state(buffer_state_t* state, const void* input, size_t len)
{
...
/* Return value: bool */
static int calc_chunk(uint8_t chunk[CHUNK_SIZE], buffer_state_t* state)
{
...
static void calc_sha_256(uint8_t hash[32], const void* input, size_t len)
{
	...
	for(unsigned int i = 0, j = 0; i < 8; i++)
	{
